...
state_file_basenames = {file.stem for file in state_files}
filtered_edf_files = [file for file in files if file.stem in state_file_basenames]

# 
for file_test, curr_state in zip(filtered_edf_files, state_files): 
    # read in file 
